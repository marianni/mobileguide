...
public class RestClients {
    ...
    public static MapEndpoint map() {
        return RestClientGenerator.generateClient(MapEndpoint.class, DEFAULT_URL);
    }

    public static LoginEndpoint login() {
        return RestClientGenerator.generateClient(LoginEndpoint.class, DEFAULT_URL);
    }
}
